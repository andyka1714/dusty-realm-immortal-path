...
const App: React.FC = () => {
  ...
  // --- 2. MAIN GAME LAYOUT ---
  return (
    <div className="flex flex-col md:flex-row h-screen w-screen bg-stone-950 text-stone-200 font-serif overflow-hidden">
      ...
      {/* Main Content Area */}
      <main className="flex-1 h-[calc(100dvh-65px)] md:h-screen overflow-y-auto md:overflow-hidden relative transition-all duration-300">
        {renderContent()}
      </main>
    </div>
  );
