  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogContent
        ...
        className={clsx(
          "!left-1/2 !top-auto !bottom-0 !w-full !max-w-none !translate-x-[-50%] !translate-y-0 rounded-t-[30px] rounded-b-none border border-amber-700/20 p-0 pt-0 md:!bottom-auto md:!top-1/2 md:!h-[90vh] md:!max-h-[960px] md:!w-[min(95vw,1500px)] md:!translate-y-[-50%] md:rounded-[30px]",
          widthClassName
        )}
