...
describe("npcSpriteAsset", () => {
  ...
  it("resolves the generated and QC-passed idle sheet for Su Ling", () => {
    const shopkeeper = MYSTIC_SECT_NPCS.find(
      (npc) => npc.id === "sect_mystic_wanbao"
    );
    ...
    const asset = getAssetDefinition("npc.wanbao_clerk.mystic.idle_v1");
    ...
    expect(getAssetFrameFileUrls(asset.assetId)).toEqual([
      "/assets/generated/characters/npcs/wanbao-clerk-mystic-idle-v1/frames/npc_idle-1.png",
      "/assets/generated/characters/npcs/wanbao-clerk-mystic-idle-v1/frames/npc_idle-2.png",
      "/assets/generated/characters/npcs/wanbao-clerk-mystic-idle-v1/frames/npc_idle-3.png",
      "/assets/generated/characters/npcs/wanbao-clerk-mystic-idle-v1/frames/npc_idle-4.png",
    ]);
  });

  it("resolves the generated and QC-passed idle sheet for Luoxia Qishi", () => {
    const forgemaster = MYSTIC_SECT_NPCS.find(
      (npc) => npc.id === "sect_mystic_lingbao"
    );
    ...
    const asset = getAssetDefinition("npc.lingbao_forgemaster.mystic.idle_v1");
    ...
    expect(getAssetFrameFileUrls(asset.assetId)).toEqual([
      "/assets/generated/characters/npcs/lingbao-forgemaster-mystic-idle-v1/frames/npc_idle-1.png",
      "/assets/generated/characters/npcs/lingbao-forgemaster-mystic-idle-v1/frames/npc_idle-2.png",
      "/assets/generated/characters/npcs/lingbao-forgemaster-mystic-idle-v1/frames/npc_idle-3.png",
      "/assets/generated/characters/npcs/lingbao-forgemaster-mystic-idle-v1/frames/npc_idle-4.png",
    ]);
  });

  it("resolves the generated and QC-passed idle sheet for Yunce Steward", () => {
    const keeper = MYSTIC_SECT_NPCS.find(
      (npc) => npc.id === "sect_mystic_skills"
    );
    ...
    const asset = getAssetDefinition("npc.scripture_keeper.mystic.idle_v1");
    ...
    expect(getAssetFrameFileUrls(asset.assetId)).toEqual([
      "/assets/generated/characters/npcs/scripture-keeper-mystic-idle-v1/frames/npc_idle-1.png",
      "/assets/generated/characters/npcs/scripture-keeper-mystic-idle-v1/frames/npc_idle-2.png",
      "/assets/generated/characters/npcs/scripture-keeper-mystic-idle-v1/frames/npc_idle-3.png",
      "/assets/generated/characters/npcs/scripture-keeper-mystic-idle-v1/frames/npc_idle-4.png",
    ]);
  });
