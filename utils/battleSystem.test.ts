...
describe("battle system balance", () => {
  ...
  it("surfaces high-realm passive opening logs for ancient body and immortal sword styles", () => {
    ...
    const bodyResult = runAutoBattle(ancientBody, BOSS_ENEMIES.m121_b1);
    expect(bodyResult.logs.some((log) => log.message.includes("荒古戰體"))).toBe(true);

    const swordResult = runAutoBattle(immortalSword, BOSS_ENEMIES.m180_b1);
  ...
  it("surfaces fusion mage passive on basic world strikes", () => {
    fixedRandom.mockReturnValue(0.5);
  ...
  it("surfaces spirit-severing mage passive on basic world strikes", () => {
    fixedRandom.mockReturnValue(0.5);
  ...
  it("surfaces immortal mage passive on basic world strikes", () => {
    fixedRandom.mockReturnValue(0.5);
  ...
  it("surfaces emperor mage passive on basic world strikes", () => {
    fixedRandom.mockReturnValue(0.5);
