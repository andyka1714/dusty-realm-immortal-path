...
const buildThemeMacroZones = ({
  ...
  if (theme === "Center") {
    if (mapId === "120") {
      ...
      forcedZones.push({ x: centerX - 2, y: centerY - 1, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX + 2, y: centerY + 1, radius: 0, kind: "accent" });
    }
  }
  ...
  if (theme === "Sect") {
    if (mapId === "4") {
      ...
      forcedZones.push({ x: centerX, y: centerY, radius: 0, kind: "path" });
      pushHorizontalLine(forcedZones, centerY, 2, centerX - 2, "water");
      pushHorizontalLine(forcedZones, centerY, centerX + 2, width - 3, "water");
      forcedZones.push({ x: centerX, y: centerY - 2, radius: 0, kind: "accent" });
    }
  }
  ...
  if (theme === "North") {
    if (mapId === "1") {
      ...
      pushHorizontalLine(forcedZones, centerY, 2, width - 3, "path");
      forcedZones.push({ x: centerX, y: centerY - 2, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX, y: centerY - 4, radius: 0, kind: "accent" });
      ...
      pushVerticalLine(forcedZones, centerX, 2, height - 3, "path");
      pushVerticalLine(forcedZones, centerX - 2, 2, height - 3, "water");
      pushVerticalLine(forcedZones, centerX + 2, 2, height - 3, "water");
    } else if (mapId === "32") {
      pushVerticalLine(forcedZones, centerX, 2, height - 3, "accent");
      pushHorizontalLine(forcedZones, centerY, centerX - 1, centerX + 1, "path");
    } else if (mapId === "7") {
      forcedZones.push({ x: centerX, y: centerY, radius: 0, kind: "path" });
      forcedZones.push({ x: centerX - 1, y: centerY - 1, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX + 1, y: centerY - 1, radius: 0, kind: "accent" });
      ...
      forcedZones.push({ x: centerX - 3, y: centerY - 2, radius: 1, kind: "path" });
      forcedZones.push({ x: centerX + 2, y: centerY + 1, radius: 1, kind: "path" });
    } else if (mapId === "62") {
      pushHorizontalLine(forcedZones, centerY, 2, width - 3, "path");
  ...
  if (theme === "East") {
    if (mapId === "20") {
      ...
      pushVerticalLine(forcedZones, centerX + 2, 2, height - 3, "water");
      pushHorizontalLine(forcedZones, centerY, 2, width - 3, "path");
      forcedZones.push({ x: centerX - 1, y: centerY - 2, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX + 1, y: centerY + 2, radius: 0, kind: "accent" });
    } else if (mapId === "21") {
      forcedZones.push({ x: centerX - 2, y: centerY - 2, radius: 1, kind: "water" });
      forcedZones.push({ x: centerX + 2, y: centerY + 2, radius: 1, kind: "water" });
      forcedZones.push({ x: centerX, y: centerY, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX - 1, y: centerY + 2, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX + 1, y: centerY - 2, radius: 0, kind: "accent" });
    } else if (mapId === "22") {
      pushHorizontalLine(forcedZones, centerY - 3, 2, width - 3, "water");
      forcedZones.push({ x: centerX, y: centerY, radius: 1, kind: "path" });
      forcedZones.push({ x: centerX - 2, y: centerY - 1, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX + 2, y: centerY - 1, radius: 0, kind: "accent" });
    } else if (mapId === "50") {
      pushVerticalLine(forcedZones, centerX, 2, height - 3, "path");
      forcedZones.push({ x: centerX - 2, y: centerY - 2, radius: 1, kind: "accent" });
      forcedZones.push({ x: centerX + 2, y: centerY - 2, radius: 1, kind: "accent" });
      forcedZones.push({ x: centerX - 2, y: centerY + 2, radius: 1, kind: "alt" });
      forcedZones.push({ x: centerX + 2, y: centerY + 2, radius: 1, kind: "alt" });
    } else if (mapId === "51") {
      forcedZones.push({ x: centerX - 2, y: centerY, radius: 1, kind: "water" });
      forcedZones.push({ x: centerX + 2, y: centerY, radius: 1, kind: "water" });
      forcedZones.push({ x: centerX, y: centerY, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX - 1, y: centerY - 2, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX + 1, y: centerY + 2, radius: 0, kind: "accent" });
      ...
      forcedZones.push({ x: centerX - 3, y: centerY - 3, radius: 0, kind: "path" });
      forcedZones.push({ x: centerX + 2, y: centerY + 2, radius: 0, kind: "path" });
      pushVerticalLine(forcedZones, centerX - 1, 2, height - 3, "accent");
      pushHorizontalLine(forcedZones, centerY + 1, 2, width - 3, "accent");
    } else if (mapId === "26") {
      forcedZones.push({ x: centerX, y: centerY, radius: 0, kind: "water" });
      forcedZones.push({ x: centerX - 1, y: centerY - 1, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX + 1, y: centerY - 1, radius: 0, kind: "accent" });
      ...
      pushVerticalLine(forcedZones, centerX, 2, height - 3, "accent");
      forcedZones.push({ x: centerX - 1, y: centerY - 1, radius: 0, kind: "water" });
      forcedZones.push({ x: centerX + 1, y: centerY + 1, radius: 0, kind: "water" });
    }
  }
  ...
  if (theme === "West") {
    if (mapId === "10") {
      ...
      forcedZones.push({ x: centerX - 3, y: centerY + 2, radius: 0, kind: "path" });
      forcedZones.push({ x: centerX - 1, y: centerY, radius: 0, kind: "path" });
      forcedZones.push({ x: centerX + 1, y: centerY - 2, radius: 0, kind: "path" });
      forcedZones.push({ x: centerX + 3, y: centerY - 4, radius: 0, kind: "path" });
      forcedZones.push({ x: centerX - 2, y: centerY + 1, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX + 2, y: centerY - 1, radius: 0, kind: "accent" });
    } else if (mapId === "12") {
      pushHorizontalLine(forcedZones, centerY, 2, width - 3, "path");
      ...
      pushVerticalLine(forcedZones, centerX, 2, centerY, "path");
      forcedZones.push({ x: centerX, y: centerY, radius: 1, kind: "path" });
      forcedZones.push({ x: centerX - 2, y: centerY - 2, radius: 0, kind: "accent" });
      forcedZones.push({ x: centerX + 2, y: centerY + 2, radius: 0, kind: "accent" });
    } else if (mapId === "41") {
