...
export const ITEMS: Record<string, Item> = {
  ...
  // Breakthrough Items (Updated for 12 Realms)
  ...
  'bt_spirit_void': { id: 'bt_spirit_void', name: '太虛破障丹', type: 'breakthrough', description: '觸摸虛空壁壘，以虛化實。突破煉虛期必備。', price: 150000, rarity: 5 },
  'bt_void_fusion': { id: 'bt_void_fusion', name: '萬法歸一髓', type: 'breakthrough', description: '肉身與神魂深度融合，觸摸法則邊緣。突破合體期必備。', price: 300000, rarity: 5 },
  'bt_fusion_maha': { id: 'bt_fusion_maha', name: '天道感悟果', type: 'breakthrough', description: '參透世間規則，引發天道共鳴。突破大乘期必備。', price: 800000, rarity: 5 },
  'bt_maha_trib': { id: 'bt_maha_trib', name: '九轉渡劫丹', type: 'breakthrough', description: '以九轉藥力護住心脈，直面天劫洗禮。突破渡劫期必備。', price: 2000000, rarity: 5 },
  'bt_trib_immortal': { id: 'bt_trib_immortal', name: '飛昇仙引', type: 'breakthrough', description: '凝聚仙元，洗去凡胎，踏入仙道。突破人仙必備。', price: 5000000, rarity: 5 },
  'bt_immortal_emperor': { id: 'bt_immortal_emperor', name: '鴻蒙本源', type: 'breakthrough', description: '宇宙誕生初期的原始能量，證道仙帝。突破仙帝必備。', price: 9999999, rarity: 6 },
  
  // Consumables
  'longevity_pill': { id: 'longevity_pill', name: '長生丹', type: 'pill', description: '奪天地造化，強行延壽10年。一生只能服用5次。', price: 50000, rarity: 4, effects: { lifespan: 3650 }, maxConsumption: 5 },
