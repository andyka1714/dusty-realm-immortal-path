...
export const BOSS_ENEMIES: Record<string, Enemy> = {
    ...
    // qi
    'm8_boss': createEnemy('m8_boss', '裂風狼王', MajorRealm.QiRefining, EnemyRank.Boss, 6500, 440, 210, ElementType.Wood, ['bt_qi_foundation'], 2000, MINOR_REALM.PEAK, '狼'), // Fast (HP-19%, Atk+10%, Def-16%)
    'm11_boss': createEnemy('m11_boss', '寒霜白猿', MajorRealm.QiRefining, EnemyRank.Boss, 9500, 340, 280, ElementType.Water, ['bt_qi_foundation'], 3000, MINOR_REALM.PEAK, '猿'), // Tank (HP+19%, Atk-15%, Def+12%)
    'm14_boss': createEnemy('m14_boss', '墨色水怪', MajorRealm.QiRefining, EnemyRank.Boss, 8800, 380, 240, ElementType.Water, ['bt_qi_foundation'], 3500, MINOR_REALM.PEAK, '怪'), // Sponge (HP+10%, Atk-5%, Def-4%)
    'm17_boss': createEnemy('m17_boss', '雷翼大隼', MajorRealm.QiRefining, EnemyRank.Boss, 7000, 460, 220, ElementType.Metal, ['bt_qi_foundation'], 4000, MINOR_REALM.PEAK, '隼'), // DPS (HP-12%, Atk+15%, Def-12%)
    'm19_boss': createEnemy('m19_boss', '金睛虎王', MajorRealm.QiRefining, EnemyRank.Boss, 8000, 400, 250, ElementType.Wood, ['bt_qi_foundation'], 4500, MINOR_REALM.PEAK, '虎'), // Standard (Baseline)
    // foundation
