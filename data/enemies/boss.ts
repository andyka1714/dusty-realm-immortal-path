...
export const BOSS_ENEMIES: Record<string, Enemy> = {
    // mortal
    'm7_boss': createEnemy('m7_boss', '守塚老屍', MajorRealm.Mortal, EnemyRank.Boss, 2000, 80, 42, ElementType.Earth, ['spirit_stone', 'bt_mortal_qi', 'novice_sword', 'wooden_shield', 'straw_hat', 'novice_robe', 'straw_sandals', 'wooden_charm'], 400),
    // qi
    ...
    'm11_boss': createEnemy('m11_boss', '寒霜白猿', MajorRealm.QiRefining, EnemyRank.Boss, 30000, 600, 350, ElementType.Water, ['bt_qi_foundation'], 3000),
    'm14_boss': createEnemy('m14_boss', '墨色水怪', MajorRealm.QiRefining, EnemyRank.Boss, 35000, 650, 300, ElementType.Water, ['bt_qi_foundation'], 3500),
    'm17_boss': createEnemy('m17_boss', '雷翼大隼', MajorRealm.QiRefining, EnemyRank.Boss, 35000, 750, 250, ElementType.Metal, ['bt_qi_foundation'], 4000),
    'm19_boss': createEnemy('m19_boss', '金睛虎王', MajorRealm.QiRefining, EnemyRank.Boss, 42000, 700, 450, ElementType.Wood, ['bt_qi_foundation'], 4500),
    // foundation
    'm22_boss': createEnemy('m22_boss', '極地劍靈', MajorRealm.Foundation, EnemyRank.Boss, 150000, 3500, 1500, ElementType.Water, ['bt_foundation_gold'], 12000),
    ...
    'm29_boss': createEnemy('m29_boss', '雷澤領主', MajorRealm.Foundation, EnemyRank.Boss, 200000, 5000, 2000, ElementType.Metal, ['bt_foundation_gold'], 15000),
    'm34_boss': createEnemy('m34_boss', '萬獸獸王', MajorRealm.Foundation, EnemyRank.Boss, 300000, 3500, 3500, ElementType.Wood, ['bt_foundation_gold'], 22000),
    // gold
    ...
    'm42_boss': createEnemy('m42_boss', '百眼蛛母', MajorRealm.GoldenCore, EnemyRank.Boss, 900000, 11000, 7000, ElementType.Wood, ['bt_gold_nascent'], 65000),
    // nascent
    'm44_boss': createEnemy('m44_boss', '無名劍修', MajorRealm.NascentSoul, EnemyRank.Boss, 3000000, 50000, 20000, ElementType.Metal, ['bt_nascent_spirit'], 200000),
    'm46_boss': createEnemy('m46_boss', '星塵巨人', MajorRealm.NascentSoul, EnemyRank.Boss, 3500000, 45000, 45000, ElementType.Earth, ['bt_nascent_spirit'], 250000),
    ...
    // immortal
    'm64_boss': createEnemy('m64_boss', '巡天神將', MajorRealm.Immortal, EnemyRank.Boss, 2500000000, 15000000, 8000000, ElementType.Metal, ['bt_immortal_emperor'], 1000000000),
