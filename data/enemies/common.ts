...
export const COMMON_ENEMIES: Record<string, Enemy> = {
    ...
    'm31_c2': createEnemy('m31_c2', '寒冰骷髏', MajorRealm.Foundation, EnemyRank.Common, 7200, 660, 370, ElementType.Water, [], 810, MINOR_REALM.MID, '髏'),
    'm32_c1': createEnemy('m32_c1', '紫電靈鷲', MajorRealm.Foundation, EnemyRank.Common, 10500, 975, 450, ElementType.Metal, [], 1200, MINOR_REALM.LATE, '鷲'),
    ...
    'm41_c2': createEnemy('m41_c2', '嗜血妖花', MajorRealm.Foundation, EnemyRank.Common, 7800, 650, 390, ElementType.Wood, [], 810, MINOR_REALM.MID, '花'),
    ...
    'm50_c2': createEnemy('m50_c2', '奪靈毒蚊', MajorRealm.Foundation, EnemyRank.Common, 3000, 600, 150, ElementType.Wood, [], 520, MINOR_REALM.INITIAL, '蚊'),
    ...
    'm51_c2': createEnemy('m51_c2', '毒液飛蛾', MajorRealm.Foundation, EnemyRank.Common, 8300, 640, 410, ElementType.Wood, [], 810, MINOR_REALM.MID, '蛾'),
    ...
    'm52_c2': createEnemy('m52_c2', '紫電銀鰻', MajorRealm.Foundation, EnemyRank.Common, 9800, 1050, 450, ElementType.Metal, [], 1250, MINOR_REALM.LATE, '鰻'),
    ...
    'm61_c2': createEnemy('m61_c2', '浮島翼人', MajorRealm.GoldenCore, EnemyRank.Common, 36000, 3400, 1750, ElementType.Metal, [], 5100, MINOR_REALM.MID, '翼'),
    ...
    'm62_c2': createEnemy('m62_c2', '斷罪獄卒', MajorRealm.GoldenCore, EnemyRank.Common, 58000, 4400, 2200, ElementType.Metal, [], 8100, MINOR_REALM.LATE, '卒'),
    // West
    ...
    'm71_c2': createEnemy('m71_c2', '炎甲蟲', MajorRealm.GoldenCore, EnemyRank.Common, 41000, 3200, 2000, ElementType.Fire, [], 5100, MINOR_REALM.MID, '蟲'),
    ...
    'm72_c2': createEnemy('m72_c2', '噬毒蜈蚣', MajorRealm.GoldenCore, EnemyRank.Common, 65000, 4300, 2350, ElementType.Wood, [], 8100, MINOR_REALM.LATE, '蚣'),
    // East
    ...
    'm81_c2': createEnemy('m81_c2', '靈島鹿靈', MajorRealm.GoldenCore, EnemyRank.Common, 35000, 3500, 1600, ElementType.Wood, [], 5100, MINOR_REALM.MID, '鹿'),
    ...
    'm82_c2': createEnemy('m82_c2', '迷霧海葵', MajorRealm.GoldenCore, EnemyRank.Common, 56000, 4700, 2050, ElementType.Water, [], 8100, MINOR_REALM.LATE, '葵'),
    ...
    'm90_c2': createEnemy('m90_c2', '冰霜女妖', MajorRealm.NascentSoul, EnemyRank.Common, 115000, 9200, 4600, ElementType.Water, [], 21000, MINOR_REALM.INITIAL, '女'),
    ...
    'm91_c2': createEnemy('m91_c2', '天光靈', MajorRealm.NascentSoul, EnemyRank.Common, 175000, 13200, 6800, ElementType.Metal, [], 36000, MINOR_REALM.MID, '光'),
    ...
    'm92_c2': createEnemy('m92_c2', '鎮劍石靈', MajorRealm.NascentSoul, EnemyRank.Common, 290000, 17500, 9200, ElementType.Earth, [], 51000, MINOR_REALM.LATE, '石'),
    // West
    ...
    'm100_c2': createEnemy('m100_c2', '荒地暴龍', MajorRealm.NascentSoul, EnemyRank.Common, 145000, 7800, 7600, ElementType.Earth, [], 21000, MINOR_REALM.INITIAL, '龍'),
    'm101_c1': createEnemy('m101_c1', '血池孽獸', MajorRealm.NascentSoul, EnemyRank.Common, 225000, 12000, 6000, ElementType.Fire, [], 35000, MINOR_REALM.MID, '孽'),
    'm101_c2': createEnemy('m101_c2', '龍血蚊', MajorRealm.NascentSoul, EnemyRank.Common, 220000, 12500, 6100, ElementType.Fire, [], 36000, MINOR_REALM.MID, '蚊'),
    'm102_c1': createEnemy('m102_c1', '蠻荒巫衛', MajorRealm.NascentSoul, EnemyRank.Common, 360000, 16500, 10500, ElementType.Earth, [], 50000, MINOR_REALM.LATE, '巫'),
    'm102_c2': createEnemy('m102_c2', '荒古咒柱', MajorRealm.NascentSoul, EnemyRank.Common, 350000, 16000, 10800, ElementType.Wood, [], 51000, MINOR_REALM.LATE, '咒'),
    // East
    ...
    'm110_c2': createEnemy('m110_c2', '精神體', MajorRealm.NascentSoul, EnemyRank.Common, 110000, 10800, 3800, ElementType.Water, [], 21000, MINOR_REALM.INITIAL, '精'),
    'm111_c1': createEnemy('m111_c1', '幽冥戰鬼', MajorRealm.NascentSoul, EnemyRank.Common, 195000, 14250, 6000, ElementType.Fire, [], 35000, MINOR_REALM.MID, '戰'),
    'm111_c2': createEnemy('m111_c2', '地煞陰卒', MajorRealm.NascentSoul, EnemyRank.Common, 190000, 14500, 6200, ElementType.Fire, [], 36000, MINOR_REALM.MID, '卒'),
    ...
    'm112_c2': createEnemy('m112_c2', '虛空掠食者', MajorRealm.NascentSoul, EnemyRank.Common, 260000, 17500, 8400, ElementType.Metal, [], 5100, MINOR_REALM.LATE, '掠'),
    ...
    'm121_c2': createEnemy('m121_c2', '殘念魔刃', MajorRealm.SpiritSevering, EnemyRank.Common, 1100000, 72000, 36000, ElementType.Metal, [], 155000, MINOR_REALM.PEAK, '刃'),

    // === [6] Void Refining (煉虛) ===
    // Player: HP ~2.5M, Atk ~150k
    // Early: HP 3M, Atk 180k, Def 90k
    // Late: HP 6M, Atk 375k, Def 180k
    'm130_c1': createEnemy('m130_c1', '光陰蜉蝣', MajorRealm.VoidRefining, EnemyRank.Common, 3000000, 180000, 90000, ElementType.Water, [], 300000, MINOR_REALM.INITIAL, '蜉'),
    'm130_c2': createEnemy('m130_c2', '溯時靈魚', MajorRealm.VoidRefining, EnemyRank.Common, 2800000, 175000, 92000, ElementType.Water, [], 310000, MINOR_REALM.INITIAL, '魚'),
    ...
    'm131_c2': createEnemy('m131_c2', '裂空魔雲', MajorRealm.VoidRefining, EnemyRank.Common, 5800000, 360000, 185000, ElementType.Wood, [], 460000, MINOR_REALM.PEAK, '雲'),
    ...
    'm140_c2': createEnemy('m140_c2', '玄機戰獸', MajorRealm.Fusion, EnemyRank.Common, 14000000, 720000, 380000, ElementType.Metal, [], 1050000, MINOR_REALM.INITIAL, '機'),
    'm141_c1': createEnemy('m141_c1', '靈元戰體', MajorRealm.Fusion, EnemyRank.Common, 30000000, 1500000, 750000, ElementType.Wood, [], 1500000, MINOR_REALM.PEAK, '構'),
    'm141_c2': createEnemy('m141_c2', '暴亂靈渦', MajorRealm.Fusion, EnemyRank.Common, 29000000, 1450000, 760000, ElementType.Water, [], 1550000, MINOR_REALM.PEAK, '渦'),
    ...
    'm150_c2': createEnemy('m150_c2', '深海巨魷', MajorRealm.Mahayana, EnemyRank.Common, 72000000, 3600000, 1550000, ElementType.Water, [], 3100000, MINOR_REALM.INITIAL, '魷'),
    ...
    'm151_c2': createEnemy('m151_c2', '登仙執法者', MajorRealm.Mahayana, EnemyRank.Common, 145000000, 7200000, 3800000, ElementType.Metal, [], 5100000, MINOR_REALM.PEAK, '法'),
    ...
    'm160_c2': createEnemy('m160_c2', '劫火鴉', MajorRealm.Tribulation, EnemyRank.Common, 360000000, 17500000, 7600000, ElementType.Fire, [], 10500000, MINOR_REALM.INITIAL, '鴉'),
    ...
    'm161_c2': createEnemy('m161_c2', '雷光電蛇', MajorRealm.Tribulation, EnemyRank.Common, 720000000, 36000000, 15500000, ElementType.Metal, [], 15500000, MINOR_REALM.PEAK, '蛇'),
    ...
    'm170_c2': createEnemy('m170_c2', '仙宮力士', MajorRealm.Immortal, EnemyRank.Common, 1450000000, 88000000, 32000000, ElementType.Earth, [], 52000000, MINOR_REALM.INITIAL, '力'),
    'm171_c1': createEnemy('m171_c1', '金甲天衛', MajorRealm.Immortal, EnemyRank.Common, 4500000000, 225000000, 75000000, ElementType.Metal, [], 80000000, MINOR_REALM.LATE, '衛'),
    'm171_c2': createEnemy('m171_c2', '天界戰鷹', MajorRealm.Immortal, EnemyRank.Common, 4300000000, 215000000, 76000000, ElementType.Metal, [], 82000000, MINOR_REALM.LATE, '鷹'),
