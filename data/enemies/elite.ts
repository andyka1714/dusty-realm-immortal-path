...
export const ELITE_ENEMIES: Record<string, Enemy> = {
  ...
  m122_e1: createEnemy(
    ...
    "督",
    {
      description: "界橋督戰官鎮守殞星界橋，以軍陣劍令逼迫修士正面衝關。",
      affixes: ["統御", "堅甲"],
      specialAttack: {
        name: "界橋斷軍",
        cooldownSeconds: 7,
        ...
        areaRadius: 2,
        maxTargets: 3,
        statusEffect: { id: "armorBreak", duration: 2, chance: 0.34, value: 0.14 },
      },
    }
  ),
  m122_e2: {
    ...
    aiStyle: "caster",
    attackRange: 5,
    description: "墜星焚令使專以火律焚橋封路，逼出闖關者的護體空隙。",
    affixes: ["強襲", "統御"],
    specialAttack: {
      name: "墜星焚橋",
      cooldownSeconds: 7,
  ...
  m132_e1: createEnemy(
    ...
    "裂",
    {
      description: "虛淵裂守在迴廊邊界巡弋，擅長以空刃切開護體與陣法。",
      affixes: ["統御", "堅甲"],
      specialAttack: {
        name: "虛刃裂界",
        cooldownSeconds: 7,
        ...
        areaRadius: 3,
        maxTargets: 4,
        statusEffect: { id: "armorBreak", duration: 2, chance: 0.35, value: 0.16 },
      },
    }
  ),
  m132_e2: {
    ...
    aiStyle: "caster",
    attackRange: 5,
    description: "時迴觀測官以時間漣漪封鎖步調，令闖入者在迴廊中被逐段肢解。",
    affixes: ["統御", "迅影"],
    specialAttack: {
      name: "時迴封步",
      cooldownSeconds: 7,
  ...
  m142_e1: createEnemy(
    ...
    "印",
    {
      description: "法壇鎮印官以萬靈印記鎖住外來者的真元與退路。",
      affixes: ["統御", "堅甲"],
      specialAttack: {
        name: "萬靈封壇",
        cooldownSeconds: 7,
  ...
  m142_e2: {
    ...
    aiStyle: "caster",
    attackRange: 5,
    description: "靈脈誦令使藉法壇靈潮施術，擅長以禁令拖垮持久戰。",
    affixes: ["統御", "噬生"],
    specialAttack: {
      name: "靈潮禁章",
      cooldownSeconds: 7,
      ...
      areaRadius: 3,
      maxTargets: 4,
      statusEffect: { id: "poison", duration: 2, chance: 0.34, value: 0.02 },
    },
  },
  m141_e1: createEnemy(
    "m141_e1",
  ...
  m152_e1: createEnemy(
    ...
    "烽",
    {
      description: "界海鎮烽將專門截殺闖過裂潮的修士，以界壁殘壓扼殺退路。",
      affixes: ["統御", "堅甲"],
      specialAttack: {
        name: "界海壓潮",
        cooldownSeconds: 7,
  ...
  m152_e2: {
    ...
    aiStyle: "caster",
    attackRange: 6,
    description: "孤烽斷航使以天火封鎖界海路線，逼迫闖關者正面承受威壓。",
    affixes: ["強襲", "統御"],
    specialAttack: {
      name: "孤烽焚海",
      cooldownSeconds: 7,
      ...
      areaRadius: 3,
      maxTargets: 4,
      statusEffect: { id: "burn", duration: 2, chance: 0.36, value: 0.022 },
    },
  },
  m151_e1: {
    ...createEnemy(
  ...
  m162_e1: createEnemy(
    ...
    "刑",
    {
      description: "天刑鎮獄官坐鎮雷廊節點，以天刑雷鏈逐段封殺逆命者。",
      affixes: ["統御", "堅甲"],
      specialAttack: {
        name: "天刑雷鎖",
        cooldownSeconds: 7,
        ...
        areaRadius: 3,
        maxTargets: 4,
        statusEffect: { id: "paralyze", duration: 1, chance: 0.36 },
      },
    }
  ),
  m162_e2: {
    ...
    aiStyle: "caster",
    attackRange: 6,
    description: "誅命司劫使負責在雷廊盡頭執行天罰，擅長以烈雷逼出破綻。",
    affixes: ["統御", "迅影"],
    specialAttack: {
      name: "誅命劫詔",
      cooldownSeconds: 7,
  ...
  m172_e1: createEnemy(
    ...
    "刑",
    {
      description: "仙獄鎮刑將專責鎮壓飛昇逆犯，以玉詔刑律切斷一切逃脫可能。",
      affixes: ["統御", "堅甲"],
      specialAttack: {
        name: "玉詔鎖命",
        cooldownSeconds: 8,
        ...
        areaRadius: 3,
        maxTargets: 4,
        statusEffect: { id: "armorBreak", duration: 2, chance: 0.36, value: 0.18 },
      },
    }
  ),
  m172_e2: {
    ...
    aiStyle: "caster",
    attackRange: 6,
    description: "玉京禁靈使以仙獄法冊干涉真元，擅長把持久戰拖向崩盤。",
    affixes: ["統御", "噬生"],
    specialAttack: {
      name: "禁靈玉冊",
      cooldownSeconds: 8,
      ...
      areaRadius: 3,
      maxTargets: 4,
      statusEffect: { id: "poison", duration: 2, chance: 0.35, value: 0.022 },
    },
  },
  m171_e1: createEnemy(
    "m171_e1",
  ...
  m181_e1: createEnemy(
    ...
    320000000,
    ElementType.Metal,
    [...IMMORTAL_EMPEROR_SWORD_SET, ...IMMORTAL_EMPEROR_MAGIC_SET],
    620000000,
    MINOR_REALM.MID,
    "巡",
    {
      description: "太初巡道使巡視道宮外環，以本源道印試探一切靠近終極者。",
      affixes: ["統御", "堅甲", "迅影"],
      specialAttack: {
        name: "太初封律",
        cooldownSeconds: 8,
        ...
        areaRadius: 3,
        maxTargets: 4,
        statusEffect: { id: "armorBreak", duration: 2, chance: 0.4, value: 0.18 },
      },
    }
  ),
  m181_e2: {
    ...
    aiStyle: "caster",
    attackRange: 7,
    description: "歸源監印官負責在外環完成最後裁決，專以道火與印記消融真元。",
    affixes: ["統御", "強襲", "迅影"],
    specialAttack: {
      name: "歸源道火",
      cooldownSeconds: 8,
      ...
      areaRadius: 3,
      maxTargets: 4,
      statusEffect: { id: "burn", duration: 2, chance: 0.4, value: 0.024 },
    },
  },
  m182_e1: {
    ...createEnemy(
      ...
      390000000,
      ElementType.Earth,
      [...IMMORTAL_EMPEROR_BODY_SET, ...IMMORTAL_EMPEROR_MAGIC_SET],
      740000000,
      MINOR_REALM.LATE,
      "碎"
    ),
    description: "歸墟碎界將以裂界重兵鎮壓萬象殘響，專斷體魄與法相的連續站場。",
    affixes: ["統御", "堅甲", "鎮魂"],
    specialAttack: {
      name: "裂界崩輪",
      cooldownSeconds: 8,
      ...
      areaRadius: 3,
      maxTargets: 4,
      statusEffect: { id: "armorBreak", duration: 2, chance: 0.42, value: 0.2 },
    },
  },
  m182_e2: {
    ...createEnemy(
    ...
    aiStyle: "caster",
    attackRange: 7,
    description: "萬象熔界司將裂界火潮與萬象殘響熔成審判洪流，是歸墟支線最兇狠的道火監軍。",
    affixes: ["統御", "迅影", "焚界"],
    specialAttack: {
      name: "萬象熔劫",
      cooldownSeconds: 8,
      ...
      areaRadius: 3,
      maxTargets: 4,
      statusEffect: { id: "burn", duration: 2, chance: 0.42, value: 0.026 },
    },
  },
  m180_e1: {
    ...createEnemy(
...
[
  ...
  ["m122_e1", MajorRealm.SpiritSevering],
  ["m122_e2", MajorRealm.SpiritSevering],
