...
export const FALLEN_ABYSS_NPCS: NPC[] = [
    {
        ...
        affiliationLabel: '凌霄劍宗',
        roleLabel: '隕仙深淵劍痕客',
        spriteArchetype: 'world_abyss_witness',
        spriteVariant: 'sword',
        symbol: '痕',
        type: NPCType.Info,
        x: 72,
...
export const VOID_RIVER_NPCS: NPC[] = [
    {
        ...
        affiliationLabel: '凌霄劍宗',
        roleLabel: '時光長河劍碑守',
        spriteArchetype: 'world_void_river_witness',
        spriteVariant: 'sword',
        symbol: '碑',
        type: NPCType.Quest,
        x: 78,
...
export const SACRED_CITY_NPCS: NPC[] = [
    {
        ...
        affiliationLabel: '凌霄劍宗',
        roleLabel: '萬法聖城劍令使',
        spriteArchetype: 'world_sacred_city_envoy',
        spriteVariant: 'sword',
        symbol: '劍',
        type: NPCType.Quest,
        x: 72,
...
export const ENDLESS_SEA_NPCS: NPC[] = [
    {
        ...
        affiliationLabel: '凌霄劍宗',
        roleLabel: '無盡海劍潮守',
        spriteArchetype: 'world_endless_sea_witness',
        spriteVariant: 'sword',
        symbol: '潮',
        type: NPCType.Quest,
        x: 86,
...
export const TRIBULATION_PLAINS_NPCS: NPC[] = [
    {
        ...
        name: '雷雲巡候',
        affiliationLabel: '劫雲荒原',
        roleLabel: '雷雲巡候',
        spriteArchetype: 'local_tribulation_scout',
        spriteVariant: 'cloud',
        symbol: '候',
        type: NPCType.Quest,
        x: 74,
    ...
    },
    {
        ...
        affiliationLabel: '凌霄劍宗',
        roleLabel: '劫雲荒原劍盟使',
        spriteArchetype: 'world_tribulation_envoy',
        spriteVariant: 'sword',
        symbol: '盟',
        type: NPCType.Quest,
        x: 88,
    ...
    },
    {
        ...
        name: '雷爐辨材師',
        affiliationLabel: '雷爐工坊',
        roleLabel: '雷火材料辨識師',
        spriteArchetype: 'local_tribulation_workshop',
        spriteVariant: 'material_diviner',
        symbol: '材',
        type: NPCType.Quest,
        x: 118,
        y: 116,
...
export const IMMORTAL_ASCENSION_NPCS: NPC[] = [
    {
        ...
        name: '仙籍錄事',
        affiliationLabel: '接引仙殿',
        roleLabel: '仙籍錄事',
        spriteArchetype: 'local_immortal_registry',
        spriteVariant: 'keeper',
        symbol: '錄',
        type: NPCType.Quest,
        x: 72,
        y: 92,
    ...
    },
    {
        ...
        affiliationLabel: '凌霄劍宗',
        roleLabel: '接引仙殿帝劍守',
        spriteArchetype: 'world_immortal_witness',
        spriteVariant: 'sword',
        symbol: '帝',
        type: NPCType.Quest,
        x: 88,
    ...
    },
    {
        ...
        name: '仙材案牘師',
        affiliationLabel: '仙材案牘司',
        roleLabel: '仙材案牘師',
        spriteArchetype: 'local_immortal_archivist',
        spriteVariant: 'material',
        symbol: '案',
        type: NPCType.Quest,
        x: 126,
        y: 116,
...
export const GUIXU_RIFT_NPCS: NPC[] = [
    {
        ...
        name: '歸墟界圖師',
        affiliationLabel: '歸墟裂界',
        roleLabel: '裂界界圖師',
        spriteArchetype: 'local_guixu_cartographer',
        spriteVariant: 'rift',
        symbol: '圖',
        type: NPCType.Quest,
        x: 76,
    ...
    },
    {
        ...
        affiliationLabel: '凌霄劍宗',
        roleLabel: '歸墟劍星回聲',
        spriteArchetype: 'local_guixu_echo',
        spriteVariant: 'sword',
        symbol: '劍',
        type: NPCType.Info,
        x: 96,
    ...
    },
    {
        ...
        name: '歸墟終盤爐師',
        affiliationLabel: '歸墟終盤爐',
        roleLabel: '終盤爐師',
        spriteArchetype: 'local_guixu_workshop',
        spriteVariant: 'forgemaster',
        symbol: '爐',
        type: NPCType.Quest,
        x: 124,
        y: 112,
    ...
    },
    {
        ...
        name: '歸墟 v5 路諭師',
        affiliationLabel: '歸墟路諭',
        roleLabel: 'v5 路諭師',
        spriteArchetype: 'local_guixu_v5_route_oracle',
        spriteVariant: 'route',
        symbol: '諭',
        type: NPCType.Quest,
        x: 136,
    ...
    },
    {
        ...
        name: '歸墟 v5 冕爐師',
        affiliationLabel: '歸墟冕爐',
        roleLabel: 'v5 冕爐師',
        spriteArchetype: 'local_guixu_v5_workshop_seer',
        spriteVariant: 'crown_furnace',
        symbol: '冕',
        type: NPCType.Quest,
        x: 146,
        y: 116,
    ...
    },
    {
        ...
        name: '歸墟 v6 餘路行者',
        affiliationLabel: '歸墟餘路',
        roleLabel: 'v6 餘路行者',
        spriteArchetype: 'local_guixu_v6_afterpath_broker',
        spriteVariant: 'afterpath',
        symbol: '行',
        type: NPCType.Quest,
        x: 154,
        y: 102,
    ...
    },
    {
        ...
        name: '歸墟 v6 輪迴錄師',
        affiliationLabel: '輪迴錄',
        roleLabel: 'v6 輪迴錄師',
        spriteArchetype: 'local_guixu_v6_reincarnation_scribe',
        spriteVariant: 'scribe',
        symbol: '錄',
        type: NPCType.Quest,
        x: 164,
        y: 124,
