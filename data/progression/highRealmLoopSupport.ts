...
> = {
  ...
  [MajorRealm.Immortal]: {
    ...
    encounterEventIds: [
      "immortal_command_cache",
      "sword_immortal_skyforge_tribute",
      "beast_immortal_bloodbone_altar",
      "mystic_immortal_starlotus_tide",
    ],
  ...
  [MajorRealm.ImmortalEmperor]: {
    ...
    encounterSummary: "帝境遭遇直接對應裂界寶潮與三宗終盤路線，確保路線辨識和進度提速都成立。",
