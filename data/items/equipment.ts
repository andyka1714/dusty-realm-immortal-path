...
export const EQUIPMENT_ITEMS: Record<string, Item> = {
  ...
  'spirit_iron_sword': {
    ...
    description: '刻有些許靈紋的精鐵劍。', price: 100, quality: ItemQuality.Low, maxStack: 1,
  ...
  'sword_tassel': {
    ...
    description: '繫在劍柄上的流蘇。', price: 80, quality: ItemQuality.Low, maxStack: 1,
  ...
  'focus_headband': {
    ...
    description: '幫助集中精神的頭帶。', price: 80, quality: ItemQuality.Low, maxStack: 1,
  ...
  'azure_robe': {
    ...
    description: '輕盈的修仙長衫，繡有雲紋。', price: 120, quality: ItemQuality.Low, maxStack: 1,
  ...
  'light_boots': {
    ...
    description: '穿上後身輕如燕。', price: 80, quality: ItemQuality.Low, maxStack: 1,
  ...
  'whetstone_ring': {
    ...
    description: '戒指上鑲嵌著一塊磨劍石碎片。', price: 100, quality: ItemQuality.Low, maxStack: 1,
  ...
  'bear_paw_gauntlet': {
    ...
    description: '模仿棕熊巨掌打造的拳套。', price: 100, quality: ItemQuality.Low, maxStack: 1,
  ...
  'heavy_iron_shield': {
    ...
    description: '摻入了少量玄鐵，沉重無比。', price: 120, quality: ItemQuality.Low, maxStack: 1,
  ...
  'wolf_skull_helm': {
    ...
    description: '用妖狼頭骨打磨而成的頭盔。', price: 100, quality: ItemQuality.Low, maxStack: 1,
  ...
  'boar_skin_armor': {
    ...
    description: '處理過的野豬妖獸皮。', price: 140, quality: ItemQuality.Low, maxStack: 1,
  ...
  'battle_boots': {
    ...
    description: '適合踩踏與站樁的重型靴子。', price: 80, quality: ItemQuality.Low, maxStack: 1,
  ...
  'vitality_beads': {
    ...
    description: '佩戴後感到氣血翻湧。', price: 120, quality: ItemQuality.Low, maxStack: 1,
  ...
  'spirit_wood_staff': {
    ...
    description: '採自靈氣充裕的老樹枝幹。', price: 120, quality: ItemQuality.Low, maxStack: 1,
  ...
  'spirit_orb': {
    ...
    description: '能夠在戰鬥中自動汲取周圍游離的靈氣。', price: 100, quality: ItemQuality.Low, maxStack: 1,
  ...
  'mystic_crown': {
    ...
    description: '正統道修的象徵。', price: 80, quality: ItemQuality.Low, maxStack: 1,
  ...
  'taoist_vestment': {
    ...
    description: '繡有八卦陣圖，能微弱抵禦元素傷害。', price: 120, quality: ItemQuality.Low, maxStack: 1,
  ...
  'cloud_step_shoes': {
    ...
    description: '據說是仿照仙人踏雲之姿製作的鞋子。', price: 80, quality: ItemQuality.Low, maxStack: 1,
  ...
  'elemental_ring': {
    ...
    description: '戒指流轉著五色光芒。', price: 100, quality: ItemQuality.Low, maxStack: 1,
