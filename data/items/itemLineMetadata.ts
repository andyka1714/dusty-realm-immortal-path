...
> = {
  ...
  pill: {
    [MajorRealm.Mortal]: ["聚氣丹", "回春丹", "回靈丹"],
    [MajorRealm.QiRefining]: ["凝氣丹", "清脈丹", "納靈丹", "鐵骨丹"],
    [MajorRealm.Foundation]: ["培元丹", "洗髓丹", "凝神丹", "玉髓回春丹", "玉露回靈丹", "小歸元丹"],
    [MajorRealm.GoldenCore]: ["金元丹", "赤霞護心丹", "金液回靈丹", "凝元丹", "歸元丹"],
    [MajorRealm.NascentSoul]: ["嬰元丹", "紫府還血丹", "嬰息回靈丹"],
    [MajorRealm.SpiritSevering]: ["化神悟道丹", "神照回春丹", "神泉回靈丹"],
    [MajorRealm.VoidRefining]: ["太虛蘊靈丹", "虛脈生血丹", "虛海回靈丹"],
    [MajorRealm.Fusion]: ["合元丹", "歸一續命丹", "萬法回靈丹"],
    [MajorRealm.Mahayana]: ["大乘感悟丹", "菩提生血丹", "菩提回靈丹"],
    [MajorRealm.Tribulation]: ["渡劫護道丹", "雷劫續命丹", "雷劫回靈丹"],
    [MajorRealm.Immortal]: ["仙元丹", "仙露回春丹", "仙露回靈丹"],
    [MajorRealm.ImmortalEmperor]: ["鴻蒙道丹", "帝血回天丹", "帝息歸元丹"],
  },
  quest_item: {
...
> = {
  ...
  pill: {
    [MajorRealm.Mortal]: ["minor_qi_pill", "heal_pill", "spirit_recovery_pill"],
