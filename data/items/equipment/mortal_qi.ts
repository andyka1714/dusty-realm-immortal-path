...
export const MORTAL_QI_ITEMS: Record<string, Item> = {
  ...
  novice_robe: {
    ...
    subType: EquipmentType.SimpleRobe,
    description: "尋常人家穿的粗布衣服，內襯了些棉花。",
    price: 50,
    quality: ItemQuality.Low,
    maxStack: 1,
    minRealm: MajorRealm.Mortal,
  ...
  spirit_iron_sword: {
    id: "spirit_iron_sword",
    name: "紋鐵劍",
    category: ItemCategory.Equipment,
    slot: EquipmentSlot.Weapon,
    subType: EquipmentType.Sword,
    description: "刻有些許靈紋的精鐵劍。",
    price: 300,
    quality: ItemQuality.Low,
    maxStack: 1,
