...
- `Adventure` 內 auto-target 與 live world action window 的判定，現在也已開始改走 `resolveWorldCombatAutoTarget(...) / runWorldCombatStep(...)`，world interval effect 不再自己維護最近怪與出手條件邏輯
